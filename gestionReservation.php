...
?>
<div class="btn-toolbar" role="toolbar" aria-label="Toolbar with button groups" style="padding-left:0px; margin:0px;">
  <div class="btn-group " role="group" aria-label="First group" style="width:100%;">
    <button type="button" class="btn btn-light" ><a  href="gestionReservationCreer.php">CREER UNE NOUVELLE PRISE EN CHARGE</button></a>
  </div>
  <div  class="btn-group" role="group" aria-label="Second group"style="width:100%;">
    <button type="button" class="btn btn-light"><a  href="gestionReservationModifier.php">PROLONGER UNE EXISTANTE</button></a>
  </div>
</div>
<div class="btn-toolbar" role="toolbar" aria-label="Toolbar with button groups" style="padding-left:0px; margin:0px;">
  <div class="btn-group " role="group" aria-label="First group" style="width:100%;">
    <button type="button" class="btn btn-light" ><a  href="gestionReservationSupprimer.php">SUPPRIMER</button></a>
  </div>
