...
<div class="row py-6">
        ...
        <div class="card-body p-6 bg-white rounded">
          <div class="table-responsive">
            <table id="example" style="font-size:20px;  width:100%" class="table table-striped table-bordered">
              <thead>
    <tr>
    <th colspan="13"><h2 style="font-size:30px;">LISTE DES CHAMBRE</h2></th>
    </tr>
    <tr style="font-size:15px;">
    <th>NUMERO DE CHAMBRE</th>
    <th>ETAGE</th>
    <th>DISPONIBLE OU NON</th>
    ...
    <tbody>
        ...
        $date2= strtotime($dateout);

        $sql ="  SELECT   NUMEROCHAMBRE,ETAGE
        FROM chambres ";
        ...
        echo "<tr><td>".$numCh."</td><td>".$et."</td><td>".$dispo."</td></tr>";
