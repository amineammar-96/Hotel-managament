...
$ref=$_POST["referenceReservation"];
...
WHERE  IDreservation='$ref' ";
    ...
    La prise en charge REF° ".$ref." à été bien supprimer !<br>";
    echo "</div>" ;  
}
else  {
                ...
                <div class="col-md-9 register-right">
                    ...
                    <div class="tab-content" id="myTabContent">
                        <div class="tab-pane fade show active" id="home" role="tabpanel" aria-labelledby="home-tab">
                            <h3 class="register-heading">SUPPRIMER  UNE PRISE EN CHARGE</h3>
                            <div class="row register-form">
                                ...
                                <div class="col-md-6">
                                    ...
                                    <div class="form-group">
                                        ...
                                        Réference prise en charge
                                    </label>
                                        <input type="text" required class="form-control" placeholder="REF °  " name="referenceReservation" id="referenceReservation"  />
                                    </div>
                                   
                                    <div class="form-group">
                                    <input type="submit" class="btnRegister" value="Supprimer" name="supp"/>
</div>
                                </div>
                            </div>
                        </div>
