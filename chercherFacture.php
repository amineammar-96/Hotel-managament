...
<body class="bg-light">
    ...
    <div class='container'>
    <form name="form1"  method="post" action="afficherFacture.php">
                ...
                <div class="col-md-9 register-right">
                    ...
                    <div class="tab-content" id="myTabContent">
                        <div class="tab-pane fade show active" id="home" role="tabpanel" aria-labelledby="home-tab">
                            <h3 class="register-heading">CHERCHER UNE FACTURE</h3>
                            <div class="row register-form">
                                <div class="col-md-6">
                                    <div class="form-group">
                                    
                                        <label class="control-label" for="numFacture">
                                        REF° facture  
                                    </label>
                                        <input type="text" class="form-control"  id="numFacture" name="numFacture" placeholder="N° Facture *" value="" />
                                    </div> 
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="form-group">
                                    <input type="submit" class="btnRegister" value="CHERCHER" name="chercherFacture"/>
</div>
                                </div>
                            </div>
                        </div>
