...
<body class="bg-light">
    ...
    <h1><a href="homepage.php" style="text-decoration: none;"></a></h1>
    </header>
    ...
    <div class='alert alert-primary' style ='font-size: 18px ;text-align : center;' id="message1">Facture Trouvée</div>
...
<div class="row py-6">
      ...
      <div class="card rounded shadow border-0">
        <div class="card-body p-6 bg-white rounded">
          <div class="table-responsive">
            <table id="example" style="font-size:12px;  width:100%" class="table table-striped table-bordered">
              <thead>
    ...
    <tbody>
        ...
        $sql =" SELECT DISTINCT reservationID, NUMEROCHAMBRE ,NOM,PRENOM,DATEar ,DATEde  
        FROM reservation";        
       ...
       $prix = 15*$days*3;
        ...
        echo "<tr><td>".$REF."</td><td>".$numCh."</td><td>".$nom."</td><td>".$pnom."</td><td>" .$datein."</td><td>".$dateout."</td><td>".$days."</td><td>".$prix."e</td></tr>";
        }
        }
            $conn->close();
        ?>  
