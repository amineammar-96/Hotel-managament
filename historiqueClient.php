...
<body class="bg-light">
    ...
    <div class="row py-6">
        ...
        $sql1= "SELECT DISTINCT * FROM reservation  e1, reservation  e2 
        WHERE e1.NUMEROTEL = e2.NUMEROTEL 
        AND  e1.EMAIL LIKE e2.EMAIL AND  
        e1.PRENOM LIKE e2.PRENOM 
        AND e1.DATEar LIKE e2.DATEar
         AND  e1.DATEde LIKE e2.DATEde ";


        $sql2 = "SELECT 
        NOM, COUNT(NOM),
        PRENOM, COUNT(PRENOM),
        NUMEROTEL, COUNT(NUMEROTEL),
        DATEde, COUNT(DATEde),
